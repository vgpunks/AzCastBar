...
local DROPDOWN_FONT_FLAGS = {
	["|cffffa0a0None"] = "",
	["Outline"] = "OUTLINE",
	["Outline Monochrome"] = "OUTLINEMONOCHROME",
...
local options = {
	...
	},
	{
		...
		{ type = "Slider", var = "nameFontSize", label = "Font Size", min = 4, max = 30, step = 1 },
	...
	},
	{
		...
		{ type = "Slider", var = "timeFontSize", label = "Font Size", min = 4, max = 30, step = 1 },
...
--	},
	...
	},
	{
		...
		{ type = "DropDown", var = "iconAnchor", label = "Icon Anchor", list = { Left = "LEFT", Right = "RIGHT", Top = "TOP", Bottom = "BOTTOM", ["|cffffa0a0None"] = "NONE" }, y = 34 },
...
f.outline2 = CreateFrame("Frame",nil,f, BackdropTemplateMixin and "BackdropTemplate");
...
f.vers:SetText(C_AddOns.GetAddOnMetadata(modName,"Version"));
...
f.btnProfiles = CreateFrame("Button",nil,f,"UIPanelButtonTemplate", BackdropTemplateMixin and "BackdropTemplate");
...
f.plugins = {};
for i = 1, 12 do
	local b = CreateFrame("Button",nil,f.outline, BackdropTemplateMixin and "BackdropTemplate");
...
f.scroll = CreateFrame("ScrollFrame","AzCastBarPluginsScroll",f.outline,"FauxScrollFrameTemplate", BackdropTemplateMixin and "BackdropTemplate");
...
f.categories = {};
for i = 1, 8 do
	local b = CreateFrame("Button",nil,f.outline2, BackdropTemplateMixin and "BackdropTemplate");
	b:SetHeight(ITEM_HEIGHT);
...
f.scroll2 = CreateFrame("ScrollFrame","AzCastBarCategoryScroll",f.outline2,"FauxScrollFrameTemplate", BackdropTemplateMixin and "BackdropTemplate");
...
f.editMode = CreateFrame("CheckButton",nil,f,"UICheckButtonTemplate", BackdropTemplateMixin and "BackdropTemplate");
