...
function acbo:CreateProfilesDialog(owner)
	owner = owner or acbo;
	local p = CreateFrame("Frame",nil,owner,BackdropTemplateMixin and "BackdropTemplate");	-- 9.0.1: Using BackdropTemplate
	...
	p.outline = CreateFrame("Frame",nil,p,BackdropTemplateMixin and "BackdropTemplate");	-- 9.0.1: Using BackdropTemplate
