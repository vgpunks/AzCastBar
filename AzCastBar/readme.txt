...
The slash command for AzCastBar is "/acb". Using it will open the option dialog.
...
- Auras: Add detection for unit type. True or nested (ie. player vs playertarget) and if nested, do auto polling every 0.1 second or something.
