...
function acb:CreateMainBar(frameType,token,options,multi)
	local f = self:CreateBar(frameType,nil,"AzCastBarPlugin"..token,BackdropTemplateMixin and "BackdropTemplate");	-- 9.0.1: Using BackdropTemplate
...
function acb:CreateBar(frameType,mainBar,name)
	local f = CreateFrame(frameType or "Frame",name,UIParent,BackdropTemplateMixin and "BackdropTemplate");	-- 9.0.1: Using BackdropTemplate
	f:SetSize(250,18);
	f:Hide();
